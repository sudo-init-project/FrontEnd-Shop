    ...
    <BrowserRouter>
      <Routes>
        <Route path='/' element={<App />}>
          <Route path='/inicio' element={<Inicio tituloTablaProductos={"Listado de Productos EGI FINAL FINAL 3" } tituloTablaClientes={"Listado de Clientes"}/>} /> {/*Aquí paso el título de la tabla por prop*/}
