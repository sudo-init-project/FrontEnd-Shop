    ...
    <BrowserRouter>
      <Routes>
        <Route path='/' element={<App />}>
          <Route path='/inicio' element={<Inicio tituloTablaProductos={"Listado de Productos" } /* Cambiamos Lista de Productos EGI FINAL FINAL 3.1 */ tituloTablaClientes={"Listado de Clientes"}/>} /> {/*Aquí paso el título de la tabla por prop*/}
