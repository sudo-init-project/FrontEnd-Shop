    ...
    <BrowserRouter>
      <Routes>
        <Route path='/' element={<App />}>
          <Route path='/inicio' element={<Inicio tituloTablaProductos={"Listado de Productos EGI 3 xd "} tituloTablaClientes={"Listado de Clientes"}/>} /> {/*Aquí paso el título de la tabla por prop*/}
