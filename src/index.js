    ...
    <BrowserRouter>
      <Routes>
        <Route path='/' element={<App />}>
          <Route path='/inicio' element={<Inicio tituloTablaProductos={"Listado de Productos"} tituloTablaClientes={"Listado de Clientes"}/>} /> {/*Aquí paso el título de la tabla por prop*/}
